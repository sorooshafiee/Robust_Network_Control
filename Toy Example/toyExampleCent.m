...
function data = toyExampleCent(con1,con2,objP1,objP2,conW1,conW2,conFS,x1,x2,u1,u2,w1,w2,fDual,fPlot)
    ...
    fprintf('Centralized Problem: Robust problem objective: %f + %f = %f\n',value(objP1),...
    ...
    if fPlot
        ...
        plot(conFS,x1(:,2),[244, 182, 182]/255); %[0.466, 0.674, 0.188]
        hold on;
        plot(conf,x1(:,2),[179, 179, 249]/255); %[0.929, 0.694, 0.125]
        grid on;
%         alpha(0.5)
